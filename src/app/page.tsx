            ...
            <section className="py-20 lg:py-28 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        <FadeUp>
                            <h2 className="text-3xl md:text-4xl font-bold text-primary mb-6">Built on Integrity. <br />Driven by Precision.</h2>
            ...
            <section className="py-20 lg:py-28 bg-sectionBg">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid lg:grid-cols-2 gap-10">
                        {/* Indian Practice */}
                        <FadeUp delay={0.1} className="bg-white p-8 md:p-10 rounded-sm shadow-sm border border-gray-100 h-full flex flex-col group hover:shadow-md transition-shadow">
                        ...
                        {/* US Outsourcing */}
                        <FadeUp delay={0.2} className="bg-white p-8 md:p-10 rounded-sm shadow-sm border border-gray-100 h-full flex flex-col group hover:shadow-md transition-shadow">
                            <div className="flex items-center mb-6">
                                <span className="text-4xl mr-4">🇺🇸</span>
            ...
            <section className="py-20 lg:py-28 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <StaggerContainer className="flex flex-wrap gap-3 md:gap-4">
                        {[
                            "IT & Software Services", "Food & Hospitality", "Manufacturing",
                            "Trading & Distribution", "Professional Services", "Startups & E-commerce",
                            "Shipping & Logistics", "Real Estate"
                        ].map((industry, i) => (
                            <StaggerItem key={i} className="bg-sectionBg border border-gray-100 px-6 py-3 rounded-full text-sm font-medium text-gray-800 hover:bg-white hover:border-primary hover:text-primary transition-colors cursor-default">
                                {industry}
                            </StaggerItem>
                        ))}
                    </StaggerContainer>
